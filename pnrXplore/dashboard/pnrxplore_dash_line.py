...
class PnrXploreDashLine(PnrXploreDashItem):
    ...
    def __auto_set_xscale(self):
        self.set_option(
            "xScale",
            self.Scale(
                type="point", min="auto", max="auto", stacked=True, reverse=False
            ),
        )
    ...
    def __auto_set_yscale(self):
        self.set_option(
            "yScale",
            self.Scale(type="linear", min="0", max="auto", stacked=True, reverse=False),
        )
    ...
    def asdict(self):
        ...
        theme_dict = {
            "theme": {
                "crosshair": {
                    "line": {"strokeWidth": 2, "stroke": "#007d74", "strokeOpacity": 1}
                },
                "tooltip": {
                    "container": {
                        "background": "#043b37",
                ...
                "axis": {
                    "legend": {"text": {"fill": "#dbb572", "fontSize": 14}},
